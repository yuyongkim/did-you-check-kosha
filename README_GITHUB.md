...
```
                Code-only detected    RAG detected
VES-GOLD-001    0                     1 (M-69-2012)
VES-GOLD-009    0                     1 (C-C-23-2026)
PIP-GOLD-047    0                     1 (Article 256 + B-M-18-2026)
```
...
src/
  ...
  verification/       # 4-layer engine
  cross_discipline/   # coupling validator
  rag/                # KOSHA RAG + synonym expansion
  orchestrator/       # 7-discipline pipeline

datasets/
  golden_standards/   # 220 synthetic test cases
  kosha/normalized/   # law articles + retrieval corpus

scripts/              # benchmarks + corpus sync + rebuild
...
AGPL-3.0 — free for individuals and researchers.  
For commercial use without open-sourcing your stack, contact me.
