...
7개 공학 계산 엔진(배관, 압력용기, 회전기기, 전기, 계장, 철골, 토목)을 실행하고, 4-계층 하이브리드 검증 모델로 검증한 뒤, **KOSHA 무료 공공 규제 코퍼스** — 1,039건의 기술지침과 3,102건의 법령 조문 — 에 대해 로컬 RAG로 규제 적합성을 확인합니다.
