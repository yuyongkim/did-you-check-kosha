...
> **[REVISED SECTION]** This section is part of the v3.5 revision; see RESPONSE_TO_REVIEWERS_v2 for justification.
>
...
## [REVISED] 2. Related Work

### [REVISED] 2.1 AI Applications in Process Safety
...
### [REVISED] 2.2 RAG in Technical and Regulatory Domains
...
### [REVISED] 2.3 Multi-Discipline Maintenance and Asset Integrity
...
### [REVISED] 2.4 Verification Methodology — N-Version Programming and K-Voting
...
### [REVISED] 2.5 Korean PSM Regulation and KOSHA
...
### [NEW] 2.6 Position relative to HAZOP, RBI, and Digital Twin

> **[NEW SECTION]** This section is part of the v3.5 revision; see RESPONSE_TO_REVIEWERS_v2 for justification.
>
...
## [REVISED] 4. KOSHA Regulatory Knowledge Layer

### [REVISED] 4.1 Corpus Construction
...
### [REVISED] 4.2 Retrieval and Generation Pipeline
...
### [NEW] 4.3 KOSHA Regulatory Grounding — Mandatory vs Guidance
...
### [NEW] 4.4 Why standard EPC workflows do not cover these obligations
...
## [REVISED] 5. Seven-Domain Calculation Engines and Four-Layer Verification

### [REVISED] 5.1 Domain Calculation Engines
...
### [REVISED] 5.2 Four-Layer Hybrid Verification Model
...
### [REVISED] 5.3 Cross-Discipline Consistency Validator
...
### [NEW] 5.4 Why three paths and a 1% tolerance? — K-voting design rationale
...
## [REVISED] 6. Experiments and Evaluation
...
### [REVISED] 6.1 Calculation Accuracy on the Golden Dataset (implementation verification)
...
### [REVISED] 6.2 Seven-Discipline Pipeline Evaluation
...
### [REVISED] 6.3 Cross-Discipline Validator Ablation (RQ1)
...
### [REVISED] 6.4 KOSHA RAG Regulatory Grounding — Three Cases (RQ2)
...
### [REVISED] 6.5 Curated Retrieval Benchmark (RQ2)
...
### [NEW] 6.6 Industry-Baseline Comparison and Internal Ablation
...
#### [NEW] 6.6.3 Real-plant pipeline-execution evidence
...
### [NEW] 6.7 Citation Traceability and Negative-Case Evidence
...
### [REVISED] 7.1 The jurisdiction compliance gap
...
### [NEW] 7.2 Compliance co-pilot, not replacement: HAZOP / RBI / Digital Twin / Regulatory RAG
...
### [NEW] 7.3 HAZOP scope: knowledge-based / AI-assisted, not a replacement for dynamic HAZOP
...
### [NEW] 7.4 Fitness-for-Service vs EPC standards
...
### [REVISED] 7.5 Process-safety contribution
...
### [NEW] 7.6 Reproducibility and explainability
...
## [REVISED] 8. Limitations and Future Work
...
## [NEW] Code and Data Availability
...
## [NEW] Appendix A. Real-Plant Data-Sheet Validation (VES-REAL-001)

### [NEW] A.1 Anonymisation policy and provenance
...
### [NEW] A.2 Anonymised vessel specification
...
### [NEW] A.3 Calculation-engine output
...
### [NEW] A.4 KOSHA RAG retrieval — both query variants
...
### [NEW] A.6 Synthetic-data framing considerations
...
## [NEW] Appendix B — Extended validation evidence
...
### [NEW] B.1 Per-discipline calculation accuracy
...
### [NEW] B.2 Recall@K extension (K = 1..10)
...
### [NEW] B.3 Pipeline end-to-end latency
...
### [NEW] B.4 Retrieval failure inventory
