...
|---|---:|---:|---|
| Word count | 4,928 | 12,937 | 4,928 -> 12,937  (+8,009, +163%) |
| Sections (headings) | 50 | 63 | 50 -> 63  (+13, +26%) |
| Body paragraphs | 160 | 255 | 160 -> 255  (+95, +59%) |
| Tables | 7 | 24 | 7 -> 24  (+17, +243%) |
| Figures | 0 | 5 | 5 (new) |

**TL;DR.** The revised manuscript is **2.6x** the original word count, adds **17 new tables**, **5 new figures**, and **13 new sections**. This is a major rewrite, not a typo pass.
...
| 38 | Appendix A. Real-Plant Pipeline-Execution Evidence (VES-REAL-001) | **NEW** | R1.5 | New appendix: anonymised real-plant cryogenic flare-drum case with UG-27 calculation + KOSHA RAG retrieval (both probe variants). |
