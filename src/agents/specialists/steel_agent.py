...
class SteelSpecialistAgent:
    """Steel specialist agent backed by steel verification engine."""

    def __init__(self, service: SteelVerificationService | None = None) -> None:
        self.service = service or SteelVerificationService()

    def handle_calculation(self, payload: Dict[str, object], runtime: AgentRuntime) -> Dict[str, object]:
        _ = runtime
        calculation_type = str(payload.get("calculation_type", "steel_integrity"))
