...
class PipingSpecialistAgent:
    """Real piping specialist agent backed by 4-layer verification engine."""

    def __init__(self, service: PipingVerificationService | None = None) -> None:
        self.service = service or PipingVerificationService()

    def handle_calculation(self, payload: Dict[str, object], runtime: AgentRuntime) -> Dict[str, object]:
        _ = runtime
        calculation_type = str(payload.get("calculation_type", "remaining_life"))
