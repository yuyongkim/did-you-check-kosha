...
class CivilSpecialistAgent:
    """Civil specialist agent backed by civil verification engine."""

    def __init__(self, service: CivilVerificationService | None = None) -> None:
        self.service = service or CivilVerificationService()

    def handle_calculation(self, payload: Dict[str, object], runtime: AgentRuntime) -> Dict[str, object]:
        _ = runtime
        calculation_type = str(payload.get("calculation_type", "civil_integrity"))
