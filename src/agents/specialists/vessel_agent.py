...
class VesselSpecialistAgent:
    """Static equipment specialist agent backed by vessel verification engine."""

    def __init__(self, service: VesselVerificationService | None = None) -> None:
        self.service = service or VesselVerificationService()

    def handle_calculation(self, payload: Dict[str, object], runtime: AgentRuntime) -> Dict[str, object]:
        _ = runtime
        calculation_type = str(payload.get("calculation_type", "vessel_integrity"))
